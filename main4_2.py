...
while(func.jugg(func.qianjin_x(a),func.qianjin_y(b),1.380606,2.756528, 15.301006,10.696528,2.998806,0.220528, 30.323206,15.844528)==1):
    ...
    step = step+1
    # plt.close('all')
    if func.get_distance_from_point_to_line((func.qianjin_x(a),func.qianjin_y(b)),(13.59911694,23.54228757),(20.73791694,10.36928757)) - func.get_distance_from_point_to_line((a,b),(13.59911694,23.54228757),(20.73791694,10.36928757)) > 0 :
        break
print(step)
print("直行停止点")
print(a,b)
...
for i in range(step):
    yuandian_x = func.qianjin_x(yuandian_x)
for i in range(step):
    yuandian_y = func.qianjin_y(yuandian_y)
